...
const shots = [
  ...
  // Remaining employee surfaces
  ['inbox-en.png', 'screen=inbox&locale=en&scenario=default', ['Inbox', 'Policy update', 'Wathefni']],
  ['inbox-ar.png', 'screen=inbox&locale=ar&scenario=default', ['الوارد', 'تحديث على السياسات', 'وظفني']],
  ['leave-en.png', 'screen=leave&locale=en&scenario=default', ['Leave', 'YOUR REQUESTS', 'Wathefni']],
  ['leave-ar.png', 'screen=leave&locale=ar&scenario=default', ['الإجازات', 'طلباتك', 'وظفني']],
  ['leave-request-en.png', 'screen=leave-request&locale=en&scenario=default', ['Request leave', 'Start date', 'Wathefni']],
  ['leave-request-ar.png', 'screen=leave-request&locale=ar&scenario=default', ['طلب إجازة', 'تاريخ البدء', 'وظفني']],
  ['shifts-en.png', 'screen=shifts&locale=en&scenario=default', ['Shifts', 'UPCOMING', 'Wathefni']],
  ['shifts-ar.png', 'screen=shifts&locale=ar&scenario=default', ['المناوبات', 'القادمة', 'وظفني']],
  ['attendance-en.png', 'screen=attendance&locale=en&scenario=default', ['Attendance', 'RECENT ACTIVITY', 'Wathefni']],
  ['attendance-ar.png', 'screen=attendance&locale=ar&scenario=default', ['الحضور', 'النشاط الأخير', 'وظفني']],
  ['documents-en.png', 'screen=documents&locale=en&scenario=default', ['Documents', 'Employment contract', 'Wathefni']],
  ['documents-ar.png', 'screen=documents&locale=ar&scenario=default', ['المستندات', 'عقد العمل', 'وظفني']],
  ['profile-en.png', 'screen=profile&locale=en&scenario=default', ['Profile', 'Noura Al Ahmad', 'Wathefni']],
  ['profile-ar.png', 'screen=profile&locale=ar&scenario=default', ['الملف الشخصي', 'نورة الأحمد', 'وظفني']],
  ['settings-en.png', 'screen=settings&locale=en&scenario=default', ['Settings', 'LANGUAGE', 'Wathefni']],
  ['settings-ar.png', 'screen=settings&locale=ar&scenario=default', ['الإعدادات', 'اللغة', 'وظفني']],
  ['privacy-support-en.png', 'screen=privacy-support&locale=en&scenario=default', ['Privacy & Support', 'Need help?', 'Wathefni']],
  ['privacy-support-ar.png', 'screen=privacy-support&locale=ar&scenario=default', ['الخصوصية والدعم', 'تحتاج إلى مساعدة؟', 'وظفني']],
  ['not-found-en.png', 'screen=not-found&locale=en&scenario=default', ['Page not found', 'Back to Home', 'Wathefni']],
  ['not-found-ar.png', 'screen=not-found&locale=ar&scenario=default', ['الصفحة غير موجودة', 'العودة إلى الرئيسية', 'وظفني']],
  // Backend-authoritative access states
  ['offline-en.png', 'screen=offline&locale=en&scenario=default', ["You're offline", 'Try again', 'Wathefni']],
  ['offline-ar.png', 'screen=offline&locale=ar&scenario=default', ['لا يوجد اتصال بالإنترنت', 'حاول مرة أخرى', 'وظفني']],
  ['session-expired-en.png', 'screen=session-expired&locale=en&scenario=default', ['Session expired', 'Return to sign in', 'Wathefni']],
  ['session-expired-ar.png', 'screen=session-expired&locale=ar&scenario=default', ['انتهت الجلسة', 'العودة إلى تسجيل الدخول', 'وظفني']],
  ['employee-inactive-en.png', 'screen=employee-inactive&locale=en&scenario=default', ['Account access ended', 'Sign out', 'Wathefni']],
  ['employee-inactive-ar.png', 'screen=employee-inactive&locale=ar&scenario=default', ['انتهى الوصول إلى الحساب', 'تسجيل الخروج', 'وظفني']],
  ['company-disabled-en.png', 'screen=company-disabled&locale=en&scenario=default', ['Company access paused', 'Try again', 'Wathefni']],
  ['company-disabled-ar.png', 'screen=company-disabled&locale=ar&scenario=default', ['تم إيقاف وصول الشركة مؤقتاً', 'حاول مرة أخرى', 'وظفني']],
  ['company-archived-en.png', 'screen=company-archived&locale=en&scenario=default', ['Company access ended', 'Try again', 'Wathefni']],
  ['company-archived-ar.png', 'screen=company-archived&locale=ar&scenario=default', ['انتهى وصول الشركة', 'حاول مرة أخرى', 'وظفني']],
  ['module-removed-en.png', 'screen=module-removed&locale=en&scenario=default', ['App access unavailable', 'Try again', 'Wathefni']],
  ['module-removed-ar.png', 'screen=module-removed&locale=ar&scenario=default', ['الوصول إلى التطبيق غير متاح', 'حاول مرة أخرى', 'وظفني']],
  ['app-unavailable-en.png', 'screen=app-unavailable&locale=en&scenario=default', ['Temporarily unavailable', 'Try again', 'Wathefni']],
  ['app-unavailable-ar.png', 'screen=app-unavailable&locale=ar&scenario=default', ['غير متاح مؤقتاً', 'حاول مرة أخرى', 'وظفني']],
]
