...
const COPY = {
  en: {
    ...
    jobsValidationTitleRequired: 'English title is required.',
    jobsValidationNumber: 'Enter a valid number.',
    jobsValidationVacancies: 'Vacancies must be zero or more.',
  ...
  ar: {
    ...
    jobsValidationTitleRequired: 'المسمى بالإنجليزية مطلوب.',
    jobsValidationNumber: 'أدخل رقمًا صالحًا.',
    jobsValidationVacancies: 'يجب أن يكون عدد الشواغر صفرًا أو أكثر.',
