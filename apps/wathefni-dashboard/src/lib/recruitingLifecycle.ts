...
const COPY = {
  en: {
    ...
    jobsInventoryHint: 'Filter by status, department, location, or remaining vacancies.',
    jobsDone: 'Done',
    jobsOwnershipOptional: 'Ownership (optional)',
    jobsOwnershipHint: 'Internal user ID — optional for Phase 1',
  ...
  ar: {
    ...
    jobsInventoryHint: 'صفِّ حسب الحالة أو القسم أو الموقع أو الشواغر المتبقية.',
    jobsDone: 'تم',
    jobsOwnershipOptional: 'الملكية (اختياري)',
    jobsOwnershipHint: 'معرّف مستخدم داخلي — اختياري في المرحلة الأولى',
