...
export const HR_WEB_UX_INVENTORY: UxInventoryRow[] = [
  ...
  },
  {
    ...
    disposition: 'preserve',
    notes: 'URL-backed tabs. Phase 7: Interviews/Assessments/Candidates views use HrSurfaceTabs. Interviews keep status tiles and a More menu for no-show/cancelled.',
  },
  {
    id: 'tabs.enterprise',
    family: 'tabs',
