...
const PAGE_DEFS: PageDef[] = [
  {
    ...
    api_authority: 'composed: /dashboard/work + intelligence/overview + calendar',
    in_sidebar: true,
    in_capability: true,
...
const NESTED: HrWebSurface[] = [
  ...
  nested({
    ...
    api_authority: '/dashboard/work',
    url_state: 'page',
    migration_status: 'canonical',
    notes: 'My Work / Company Attention aggregation. Source modules remain systems of action.',
  }),
  nested({
    ...
    module: null,
    permission: null,
    component: 'Needs Attention page',
    api_authority: '/dashboard/posthire/action-inbox',
    url_state: 'page',
    migration_status: 'canonical',
    notes: 'Module-page Action Inbox remains. Overview no longer peeks a second inbox authority.',
  }),
  nested({
    id: 'overview.signals',
    kind: 'overview',
