...
export function shiftsCopy(locale: ShiftsLocale) {
  ...
  return {
    ...
    advancedOrg: isAr ? 'تنظيم متقدم' : 'Advanced Organization',
    showAdvancedOrg: isAr ? 'إظهار التنظيم المتقدم' : 'Show advanced organization',
    hideAdvancedOrg: isAr ? 'إخفاء التنظيم المتقدم' : 'Hide advanced organization',
    ...
    assignmentType: isAr ? 'نوع التعيين' : 'Assignment type',
    assignmentGuest: isAr ? 'خدمة العملاء' : 'Customer-facing',
    assignmentOperations: isAr ? 'العمليات' : 'Operations',
    assignmentNight: isAr ? 'ليلي' : 'Night',
    assignmentEvent: isAr ? 'مهمة خاصة' : 'Special assignment',
    assignmentGeneral: isAr ? 'عام' : 'General',
    filters: isAr ? 'تصفية' : 'Filters',
    clearFilters: isAr ? 'مسح التصفية' : 'Clear filters',
    overnight: isAr ? 'اليوم التالي' : 'Next day',
    overnightHint: isAr ? 'اليوم التالي' : 'Next day',
    nextDay: isAr ? 'اليوم التالي' : 'Next day',
    statusConflictShort: isAr ? 'تعارض' : 'Conflict',
    statusReviewShort: isAr ? 'مراجعة' : 'Review',
    statusCancelledShort: isAr ? 'ملغاة' : 'Cancelled',
...
export function shiftStatusLabel(uiState: string | null | undefined, locale: ShiftsLocale): string {
  ...
  if (s === 'cancelled') return c.statusCancelledShort
  if (s === 'conflicted') return c.statusConflictShort
  if (s === 'reconciliation_required') return c.statusReviewShort
