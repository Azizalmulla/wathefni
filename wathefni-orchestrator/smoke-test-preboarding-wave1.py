...
def main() -> int:
    ...
    # Surface Wave may add PreboardingWorkspace; authority freeze still applies.
    freeze = orch.parent / "ops" / "PREBOARDING_WAVE1_BACKEND_FREEZE.md"
    check("preboarding backend freeze doc present", freeze.is_file())
