...
def main() -> int:
    ...
    orig_deliver = app.deliver_to_employee

    def _stub_deliver_to_employee(**kwargs):
        # Isolate the module gate from provider/company bookkeeping.
        return {
            "ok": True,
            "status": "dry_run_stub",
            "channel_used": "stub",
    ...
    app.deliver_to_employee = _stub_deliver_to_employee
    ...
    try:
        ...
        app.deliver_to_employee = orig_deliver
        cleanup(app, [CO_ON, CO_OFF])
