...
def honesty_payload() -> dict[str, Any]:
    return {
        ...
        "performance_customer_enableable": True,
        "talent_customer_enableable": True,
    ...
    *,
    ...
    if key == "performance_goals":
        try:
            ...
            pt1.sync_from_setup(
                cur, company_code=company, actor_phone=actor_phone, overlay=overlay, reason=reason
            )
        except Exception:
            pass
    if key == "talent_profile":
        try:
