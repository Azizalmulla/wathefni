...
def honesty_payload() -> dict[str, Any]:
    base = {
        ...
        "no_deactivation": False,
        "no_hard_delete": True,
        "no_silent_auto_deactivation": True,
        "no_erp_sftp": False,
        "connected_systems_p5": True,
        "connected_systems_p5_1_scheduler_sftp": True,
        "connected_systems_p5_2_secret_hardening": True,
        "leavers_lifecycle_p6": True,
    ...
    try:
        ...
        base["lifecycle"] = _p6.honesty_payload()
    except Exception:
        pass
    return base
...
def ensure_schema(cur: Any, *, force: bool = False) -> None:
    ...
    try:
        ...
        _p6.ensure_lifecycle_schema(cur, force=force)
    except Exception:
        if force:
            raise
    _SCHEMA_READY = True
