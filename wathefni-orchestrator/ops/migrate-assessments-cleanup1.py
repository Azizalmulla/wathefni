#!/usr/bin/env python3
"""Idempotent staging-only backfill for Assessments Cleanup-1."""
...
MIGRATION_KEY = "assessments_cleanup1_staging_v1"
...
def main() -> int:
    ...
    if identity.application_environment != "staging" or identity.database_environment != "staging":
        raise RuntimeError("assessments_cleanup1_migration_refuses_non_staging")
