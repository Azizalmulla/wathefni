#!/usr/bin/env python3
"""Surgically patch production app.py with Unified Candidates hooks only.
...
if "UNIFIED_CANDIDATES_PRODUCTION_DARK_PATCH" in src:
...
END_MARK = """
# UNIFIED_CANDIDATES_PRODUCTION_DARK_PATCH: late route mount after helpers exist
import unified_candidates_routes as _unified_candidates_routes
