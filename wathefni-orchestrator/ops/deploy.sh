...
preflight() {
  ...
  ( cd "$ORCH_SRC" && python3 smoke-test-tenant-read-hardening.py && python3 smoke-test-toolcall-orchestrator.py && python3 smoke-test-whatsapp-identity.py && python3 smoke-test-channel-account-routing.py && python3 smoke-test-cv-extraction-ocr.py ) || fail "local source smokes failed"
}
