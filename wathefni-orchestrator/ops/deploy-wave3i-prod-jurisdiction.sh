...
( cd "$ORCH" && /opt/wathefni/orchestrator/.venv/bin/python -c "import employee_policy_packs_wave3h as p; import employee_lifecycle_wave3c as w; print(p.SCHEMA_VERSION, w.SCHEMA_VERSION)" )
