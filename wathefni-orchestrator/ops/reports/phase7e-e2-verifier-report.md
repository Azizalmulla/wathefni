...
- Observed: `{"event": [{"channel": "outbound_layer", "payload": {"attempt_reasons": [], "channel_used": "whatsapp_session", "delivery_status": "delivered_whatsapp", "employee_message_id": "829f9dfa-75f7-4ac9-bc52-afcd55617490", "flow": "app_activation", "outbound_layer": true, "recipient_email": "p7e-app-a@synthetic.invalid", "template_key": "app_activation"}, "status": "sent"}], "message": [{"attempt_log": [{"at": "2026-07-12T08:49:33.906175+00:00", "attempt": 1, "channel": "whatsapp_session", "reasons": [], "status": "delivered_whatsapp"}], "attempts": 1, "channel_used": "whatsapp_session", "message_id": "829f9dfa-75f7-4ac9-bc52-afcd55617490", "status": "delivered_whatsapp"}], "provider_calls": {"emai…`
...
- Observed: `{"message": [{"attempt_log": [{"at": "2026-07-12T08:49:33.911014+00:00", "attempt": 1, "channel": "email", "reasons": ["session:conversation_closed", "template:template_unmapped"], "status": "sent_email_fallback"}], "attempts": 1, "channel_used": "email", "status": "sent_email_fallback"}], "provider_calls": {"email": 1, "session": 1, "template": 1}, "result": {"channel": "email", "delivery_status": "sent_email_fallback", "hr_task_id": null, "ok": true}}`

### PASS — C03g real ladder all-failed activation creates visible HR task
- Endpoint: `deliver_app_activation_code → outbound_delivery`
- Expected: `{"hr_task": "open", "status": "needs_hr_action"}`
- Observed: `{"hr_task_count": 1, "message": [{"attempt_log": [{"at": "2026-07-12T08:49:33.915582+00:00", "attempt": 1, "channel": null, "reasons": ["session:conversation_closed", "template:template_unmapped", "email:synthetic_email_failure"], "status": "needs_hr_action"}], "attempts": 1, "channel_used": null, "hr_task_id": "f1b43ffe-7f51-469a-a472-1cb59da654c0", "status": "needs_hr_action"}], "result": {"channel": null, "delivery_status": "needs_hr_action", "hr_task_id": "f1b43ffe-7f51-469a-a472-1cb59da654c0", "ok": false}}`
...
- Observed: `{"message": [{"attempt_log": [{"at": "2026-07-12T08:49:33.921601+00:00", "attempt": 1, "channel": null, "reasons": ["push:suppressed_opt_out", "session:suppressed_opt_out", "template:suppressed_opt_out", "email:suppressed_opt_out"], "status": "suppressed"}], "attempts": 1, "channel_used": null, "hr_task_id": null, "status": "suppressed"}], "provider_calls": {"email": 0, "session": 0, "template": 0}, "result": {"channel": null, "delivery_status": "suppressed", "hr_task_id": null, "ok": false}}`
...
- Observed: `{"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:33.933000+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}`
...
- Observed: `{"first": {"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-b@synthetic.invalid", "employee_key": "p7e-app-b", "locale": "en", "name": "Synthetic Employee B", "onboarding_status": "in_progress", "phone": "96555557802", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.052354+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}, "second": {"body": {"error": "app_activation_failed", "message": "That code didn't work. Ask your HR team for a new one."}, "returned": false, "status_code": 401}}`
...
### FAIL — C05e invite employee_key/phone mismatch cannot activate the wrong employee
- Endpoint: `POST /app/auth/activate`
- Expected: `{"new_sessions_for_wrong_employee": 0, "status_code": 401}`
- Observed: `{"response": {"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-d@synthetic.invalid", "employee_key": "p7e-app-d", "locale": "en", "name": "Synthetic Employee D", "onboarding_status": "in_progress", "phone": "96555557804", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.108805+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}, "sessions_after": 1, "sessions_before": 0}`
...
### FAIL — C05g disabled company blocks invite and activation
- Endpoint: `POST /dashboard/.../app-invite + POST /app/auth/activate`
- Expected: `{"activation_denied": true, "invite_denied": true}`
- Observed: `{"activation": {"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-e@synthetic.invalid", "employee_key": "p7e-app-e", "locale": "en", "name": "Synthetic Employee E", "onboarding_status": "in_progress", "phone": "96555557805", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.136144+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}, "invite": {"body": {"code": "[redacted]", "delivery": {"channel": null, "ok": false, "status": "failed"}, "employee_key": "p7e-app-e", "expires_at": "2026-07-13T08:49:34.129485+00:00", "ok": true}, "returned": true, "status_code": 200}}`

### FAIL — C05h archived company blocks invite and activation
- Endpoint: `POST /dashboard/.../app-invite + POST /app/auth/activate`
- Expected: `{"activation_denied": true, "invite_denied": true}`
- Observed: `{"activation": {"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-f@synthetic.invalid", "employee_key": "p7e-app-f", "locale": "en", "name": "Synthetic Employee F", "onboarding_status": "in_progress", "phone": "96555557806", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.148167+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}, "invite": {"body": {"code": "[redacted]", "delivery": {"channel": null, "ok": false, "status": "failed"}, "employee_key": "p7e-app-f", "expires_at": "2026-07-13T08:49:34.143146+00:00", "ok": true}, "returned": true, "status_code": 200}}`

### FAIL — C05i already-activated employee does not receive an additional privileged session
- Endpoint: `POST /app/auth/activate`
- Expected: `{"active_session_count_growth": 0, "rejected_or_idempotent": true}`
- Observed: `{"response": {"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.159139+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}, "sessions_after": 2, "sessions_before": 1}`
...
- Observed: `{"response": {"body": {"can_upload": true, "next_item": {"document_type": "civil_id", "item_id": "civil_id", "item_type": "document", "label": "Civil ID", "status": "pending"}, "ok": true, "pending": [{"document_type": "civil_id", "drive_url": null, "escalated_at": null, "file_id": null, "item_id": "civil_id", "item_type": "document", "label": "Civil ID", "last_reminded_at": null, "reminder_count": 0, "required": true, "status": "pending", "storage_provider": null, "storage_status": null, "storage_url": null, "updated_at": "2026-07-12T08:49:34.171749+00:00", "value": null}, {"document_type": "personal_photo", "drive_url": null, "escalated_at": null, "file_id": null, "item_id": "personal_phot…`
...
### FAIL — C07i server rejects extension/MIME mismatch
- Endpoint: `POST /app/onboarding/documents`
- Expected: `{"error": "mime_mismatch_or_invalid_content", "status_code": "400/415"}`
- Observed: `{"body": {"file_id": "0684fa74-511d-47fd-84c2-80665745902c", "item_id": "personal_photo", "ok": true, "storage_status": "stored"}, "returned": true, "status_code": 200}`
...
- Observed: `{"create": {"body": {"leave": {"company_code": "P7ESTG01", "created_at": "2026-07-12T08:49:34.332723+00:00", "decided_at": null, "decided_by_phone": null, "decision_note": null, "employee_key": "p7e-app-a", "employee_name": "Synthetic Employee A", "employee_phone": "96555557801", "end_date": "2099-01-12", "leave_id": "5c7e0315-56d4-4457-9341-4a128ee243cd", "leave_type": "annual", "metadata": {"action": {"end_date": "2099-01-12", "leave_type": "annual", "reason": null, "start_date": "2099-01-10", "subject_phone": "96555557801"}, "shift_conflicts": [], "source": "whatsapp"}, "reason": null, "requested_at": "2026-07-12T08:49:34.332723+00:00", "requested_by_phone": "96555557801", "source_text": …`
...
- Observed: `{"item": {"body": "Synthetic onboarding reminder", "created_at": "2026-07-12T08:49:34.353540+00:00", "flow": "onboarding", "id": "9207f0e9-a2ff-48f6-a217-e26ae504b9f1", "read": false, "status": "pending", "title": "Onboarding reminder"}, "mark": {"body": {"ok": true}, "returned": true, "status_code": 200}, "push_enabled": false}`
...
### FAIL — C10c company module removal blocks refresh
- Endpoint: `POST /app/auth/refresh`
- Expected: `{"status_code": "401/403"}`
- Observed: `{"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.360352+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}`

### FAIL — C10d company disabled blocks subsequent authenticated API access
- Endpoint: `GET /app/me (employee_app_context)`
- Expected: `{"company_status": "disabled", "status_code": "401/403"}`
- Observed: `{"body": {"actor_email": "p7e-app-a@synthetic.invalid", "actor_phone": "96555557801", "actor_role": "employee", "actor_user_id": "employee_app:p7e-app-a", "company_code": "P7ESTG01", "employee": {"app_key": null, "company_code": "P7ESTG01", "compliance_status": "pending", "created_at": "2026-07-12T08:49:33.818373+00:00", "device_user_id": null, "documents_complete": 2, "documents_pending": 2, "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "employment_status": "active", "hire_date": null, "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": null, "profile": {"marker": "phase7e_e2_verifier", "synthetic": true}, "raw…`

### FAIL — C10d2 company disabled blocks refresh
- Endpoint: `POST /app/auth/refresh`
- Expected: `{"company_status": "disabled", "status_code": "401/403"}`
- Observed: `{"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.365767+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}`

### FAIL — C10e company archived blocks subsequent authenticated API access
- Endpoint: `GET /app/me (employee_app_context)`
- Expected: `{"company_status": "archived", "status_code": "401/403"}`
- Observed: `{"body": {"actor_email": "p7e-app-a@synthetic.invalid", "actor_phone": "96555557801", "actor_role": "employee", "actor_user_id": "employee_app:p7e-app-a", "company_code": "P7ESTG01", "employee": {"app_key": null, "company_code": "P7ESTG01", "compliance_status": "pending", "created_at": "2026-07-12T08:49:33.818373+00:00", "device_user_id": null, "documents_complete": 2, "documents_pending": 2, "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "employment_status": "active", "hire_date": null, "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": null, "profile": {"marker": "phase7e_e2_verifier", "synthetic": true}, "raw…`

### FAIL — C10e2 company archived blocks refresh
- Endpoint: `POST /app/auth/refresh`
- Expected: `{"company_status": "archived", "status_code": "401/403"}`
- Observed: `{"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.370987+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}`
...
### C05e — invite employee_key/phone mismatch cannot activate the wrong employee
- Endpoint: `POST /app/auth/activate`
- Observed: `{"response": {"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-d@synthetic.invalid", "employee_key": "p7e-app-d", "locale": "en", "name": "Synthetic Employee D", "onboarding_status": "in_progress", "phone": "96555557804", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.108805+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}, "sessions_after": 1, "sessions_before": 0}`
- Expected: `{"new_sessions_for_wrong_employee": 0, "status_code": 401}`
- Smallest durable remediation: Bind activation lookup to invite.employee_key and verify it equals the resolved employee before redeeming or creating a session.

### C05g — disabled company blocks invite and activation
- Endpoint: `POST /dashboard/.../app-invite + POST /app/auth/activate`
- Observed: `{"activation": {"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-e@synthetic.invalid", "employee_key": "p7e-app-e", "locale": "en", "name": "Synthetic Employee E", "onboarding_status": "in_progress", "phone": "96555557805", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.136144+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}, "invite": {"body": {"code": "[redacted]", "delivery": {"channel": null, "ok": false, "status": "failed"}, "employee_key": "p7e-app-e", "expires_at": "2026-07-13T08:49:34.129485+00:00", "ok": true}, "returned": true, "status_code": 200}}`
- Expected: `{"activation_denied": true, "invite_denied": true}`
- Smallest durable remediation: Enforce active company lifecycle in the HR invite route and activation path before issuing/redeeming an invite.

### C05h — archived company blocks invite and activation
- Endpoint: `POST /dashboard/.../app-invite + POST /app/auth/activate`
- Observed: `{"activation": {"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-f@synthetic.invalid", "employee_key": "p7e-app-f", "locale": "en", "name": "Synthetic Employee F", "onboarding_status": "in_progress", "phone": "96555557806", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.148167+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}, "invite": {"body": {"code": "[redacted]", "delivery": {"channel": null, "ok": false, "status": "failed"}, "employee_key": "p7e-app-f", "expires_at": "2026-07-13T08:49:34.143146+00:00", "ok": true}, "returned": true, "status_code": 200}}`
- Expected: `{"activation_denied": true, "invite_denied": true}`
- Smallest durable remediation: Enforce active company lifecycle in the HR invite route and activation path before issuing/redeeming an invite.

### C05i — already-activated employee does not receive an additional privileged session
- Endpoint: `POST /app/auth/activate`
- Observed: `{"response": {"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.159139+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}, "sessions_after": 2, "sessions_before": 1}`
- Expected: `{"active_session_count_growth": 0, "rejected_or_idempotent": true}`
- Smallest durable remediation: Define activation idempotency and reject or atomically replace existing active sessions instead of accumulating privileged sessions.

### C07i — server rejects extension/MIME mismatch
- Endpoint: `POST /app/onboarding/documents`
- Observed: `{"body": {"file_id": "0684fa74-511d-47fd-84c2-80665745902c", "item_id": "personal_photo", "ok": true, "storage_status": "stored"}, "returned": true, "status_code": 200}`
- Expected: `{"error": "mime_mismatch_or_invalid_content", "status_code": "400/415"}`
- Smallest durable remediation: Add server-side MIME allowlist and extension-to-MIME/content-signature consistency validation before storage.
...
### C10c — company module removal blocks refresh
- Endpoint: `POST /app/auth/refresh`
- Observed: `{"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.360352+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}`
- Expected: `{"status_code": "401/403"}`
- Smallest durable remediation: Apply company lifecycle/module/employee eligibility gates before rotating a refresh token; revoke the session when a gate fails.

### C10d — company disabled blocks subsequent authenticated API access
- Endpoint: `GET /app/me (employee_app_context)`
- Observed: `{"body": {"actor_email": "p7e-app-a@synthetic.invalid", "actor_phone": "96555557801", "actor_role": "employee", "actor_user_id": "employee_app:p7e-app-a", "company_code": "P7ESTG01", "employee": {"app_key": null, "company_code": "P7ESTG01", "compliance_status": "pending", "created_at": "2026-07-12T08:49:33.818373+00:00", "device_user_id": null, "documents_complete": 2, "documents_pending": 2, "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "employment_status": "active", "hire_date": null, "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": null, "profile": {"marker": "phase7e_e2_verifier", "synthetic": true}, "raw…`
- Expected: `{"company_status": "disabled", "status_code": "401/403"}`
- Smallest durable remediation: Add an active-company lifecycle check to employee_app_context and all unauthenticated auth/invite paths.

### C10d2 — company disabled blocks refresh
- Endpoint: `POST /app/auth/refresh`
- Observed: `{"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.365767+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}`
- Expected: `{"company_status": "disabled", "status_code": "401/403"}`
- Smallest durable remediation: Check active company lifecycle and effective employee_app module before rotating refresh credentials.

### C10e — company archived blocks subsequent authenticated API access
- Endpoint: `GET /app/me (employee_app_context)`
- Observed: `{"body": {"actor_email": "p7e-app-a@synthetic.invalid", "actor_phone": "96555557801", "actor_role": "employee", "actor_user_id": "employee_app:p7e-app-a", "company_code": "P7ESTG01", "employee": {"app_key": null, "company_code": "P7ESTG01", "compliance_status": "pending", "created_at": "2026-07-12T08:49:33.818373+00:00", "device_user_id": null, "documents_complete": 2, "documents_pending": 2, "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "employment_status": "active", "hire_date": null, "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": null, "profile": {"marker": "phase7e_e2_verifier", "synthetic": true}, "raw…`
- Expected: `{"company_status": "archived", "status_code": "401/403"}`
- Smallest durable remediation: Add an active-company lifecycle check to employee_app_context and all unauthenticated auth/invite paths.

### C10e2 — company archived blocks refresh
- Endpoint: `POST /app/auth/refresh`
- Observed: `{"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.370987+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}`
- Expected: `{"company_status": "archived", "status_code": "401/403"}`
- Smallest durable remediation: Check active company lifecycle and effective employee_app module before rotating refresh credentials.
...
- **FAIL** C10c — company module removal blocks refresh: `{"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.360352+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}`
- **FAIL** C10d — company disabled blocks subsequent authenticated API access: `{"body": {"actor_email": "p7e-app-a@synthetic.invalid", "actor_phone": "96555557801", "actor_role": "employee", "actor_user_id": "employee_app:p7e-app-a", "company_code": "P7ESTG01", "employee": {"app_key": null, "company_code": "P7ESTG01", "compliance_status": "pending", "created_at": "2026-07-12T08:49:33.818373+00:00", "device_user_id": null, "documents_complete": 2, "documents_pending": 2, "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "employment_status": "active", "hire_date": null, "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": null, "profile": {"marker": "phase7e_e2_verifier", "synthetic": true}, "raw…`
- **FAIL** C10d2 — company disabled blocks refresh: `{"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.365767+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}`
- **FAIL** C10e — company archived blocks subsequent authenticated API access: `{"body": {"actor_email": "p7e-app-a@synthetic.invalid", "actor_phone": "96555557801", "actor_role": "employee", "actor_user_id": "employee_app:p7e-app-a", "company_code": "P7ESTG01", "employee": {"app_key": null, "company_code": "P7ESTG01", "compliance_status": "pending", "created_at": "2026-07-12T08:49:33.818373+00:00", "device_user_id": null, "documents_complete": 2, "documents_pending": 2, "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "employment_status": "active", "hire_date": null, "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": null, "profile": {"marker": "phase7e_e2_verifier", "synthetic": true}, "raw…`
- **FAIL** C10e2 — company archived blocks refresh: `{"body": {"employee": {"company_code": "P7ESTG01", "department": "", "email": "p7e-app-a@synthetic.invalid", "employee_key": "p7e-app-a", "locale": "en", "name": "Synthetic Employee A", "onboarding_status": "in_progress", "phone": "96555557801", "position_title": ""}, "expires_at": "2026-07-19T08:49:34.370987+00:00", "ok": true, "refresh_token": "[redacted]", "token": "[redacted]"}, "returned": true, "status_code": 200}`
