...
def main() -> int:
    ...
    # Setup cards are proved in unit + qualify frontend step (dashboard tree not adjacent on staging).
    check("setup card scan helper", callable(c8.frontend_setup_cards_scan))
