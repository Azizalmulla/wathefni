...
def frontend_setup_cards_scan(dashboard_setup_dir: Path | None = None) -> dict[str, Any]:
    ...
    # R5J: all seven Wave 6 Setup cards are customer-remounted.
    released = {
    ...
    er_mounted = "Wave6EmployeeRelationsPoliciesCard" in app_text
    eg_mounted = "Wave6EngagementPoliciesCard" in app_text
    cp_mounted = "Wave6CompensationPlanningPoliciesCard" in app_text
    wfp_mounted = "Wave6WorkforcePlanningPoliciesCard" in app_text
    return {
        "ok": not missing and not mounted_hidden and ja_mounted and ld_mounted and bn_mounted and er_mounted and eg_mounted and cp_mounted and wfp_mounted and app.exists(),
        ...
        "employee_relations_setup_remounted": er_mounted,
        "engagement_setup_remounted": eg_mounted,
        "comp_planning_setup_remounted": cp_mounted,
        "workforce_planning_setup_remounted": wfp_mounted,
    }
