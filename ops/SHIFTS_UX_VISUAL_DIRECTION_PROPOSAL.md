...
**Status:** PRODUCTION — stamp `20260804T175726Z` — governed `assignment_type` live  
**Evidence:** `ops/evidence/shifts-ux-direction-prod-deploy-20260804T175726Z/`  
**Model:** `ops/SHIFTS_ASSIGNMENT_TYPE_GOVERNED_MODEL.md`  
**Prerequisite:** Wave 3B roster architecture (`20260804T170817Z`)  
