...
## Qualify hygiene (non-domain)

- C1 smoke versioning prove uses an ephemeral semantic key so repeated staging qualifies do not fail on accumulated platform definition versions. Domain contracts unchanged.
