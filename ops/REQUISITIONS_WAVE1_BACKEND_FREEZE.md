...
### Amendment 2026-08-11 — Surfaces freeze (non-SM)

UI/HTTP surfaces shipped under `ops/REQUISITIONS_SURFACE_WAVE_FREEZE.md` (`REQUISITIONS_SURFACES_FULL_PASS`).  
**No change** to SM / SoD / gate / flag triple in `requisitions.py`. Rule (2) “No Requisitions UI in this freeze” applies to the *backend* freeze only; surfaces are a separate freeze.
