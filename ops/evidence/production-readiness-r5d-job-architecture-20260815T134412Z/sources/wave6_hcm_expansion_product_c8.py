...
def frontend_setup_cards_scan(dashboard_setup_dir: Path | None = None) -> dict[str, Any]:
    ...
    # R5D: Job Architecture Setup card is customer-visible. Remaining Wave 6 cards stay omitted.
    released = {"Wave6JobArchitecturePoliciesCard"}
    ...
    return {
        "ok": not missing and not mounted_hidden and ja_mounted and app.exists(),
