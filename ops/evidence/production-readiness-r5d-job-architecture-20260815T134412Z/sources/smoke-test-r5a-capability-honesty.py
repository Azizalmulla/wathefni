...
def main() -> int:
    ...
    print("\n    readiness contract")
    check("six unreleased capabilities after R5D", len(ready.UNRELEASED_CAPABILITY_KEYS) == 6)
    ...
    check("classic-wave6-learning still omitted", "classic-wave6-learning" not in setup_app)
