...
def main() -> int:
    ...
    check("learning still hidden", ready.customer_enableable("learning") is False)
    ...
    check("fail-closed keeps Learning", ("learning", "/dashboard/learning") in ready.all_http_namespaces())
    ...
    check(
        ...
        learning.status_code == 404 and isinstance(detail, dict) and detail.get("error") == "capability_not_released",
        detail,
    )
