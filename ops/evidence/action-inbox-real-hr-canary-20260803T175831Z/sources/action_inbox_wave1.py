...
ACTION_INBOX_WAVE1_VERSION = "1.0.1"
        ...
        "definitions": [
            {
                ...
                "definition_en": (
                    ...
                    "Phase 0: viewer and subject allowlists fail closed; payroll/timesheet rows excluded."
                ),
                "definition_ar": (
                    ...
                    "المرحلة 0: قوائم المشاهدين والموضوعات مغلقة عند الفراغ؛ تُستبعد صفوف الرواتب."
                ),
            },
            {
                "key": "clears",
