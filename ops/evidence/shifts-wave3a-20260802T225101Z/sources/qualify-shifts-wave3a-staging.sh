...
(
  cd "$ORCH_SRC"
  "${SCP[@]}" shifts_wave3_controlled.py shifts_schedule_integrity_wave2.py shifts_authority_wave1.py \
    smoke-test-shifts-wave3-ux.py smoke-test-shifts-wave3a-live-staging.py app.py \
