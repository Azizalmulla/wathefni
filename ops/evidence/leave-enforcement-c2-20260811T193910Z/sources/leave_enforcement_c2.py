...
def reserve_with_enforcement(
    ...
    *,
    ...
    if result.get("insufficient_balance_observe"):
        if override:
...
def post_balance_adjustment(
    ...
    *,
    ...
    cur.execute(
        ...
        RETURNING ledger_id, days, entry_kind
        """,
    ...
    _audit(
        ...
        actor_phone=actor_phone,
        reason=reason,
        payload={"ledger_id": str(row.get("ledger_id")), "days": float(amt), "leave_type": leave_type},
    )
