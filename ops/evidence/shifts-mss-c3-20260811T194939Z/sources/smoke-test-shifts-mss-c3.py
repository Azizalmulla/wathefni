...
COMPANY = f"MSS{SUFFIX}"[:12].upper()
OTHER = f"MSX{SUFFIX}"[:12].upper()
MGR = f"9655401{SUFFIX[:5]}"
MGR_OOS = f"9655402{SUFFIX[:5]}"
EMP_A = f"9655403{SUFFIX[:5]}"
EMP_B = f"9655404{SUFFIX[:5]}"
EMP_OUT = f"9655405{SUFFIX[:5]}"
...
def main() -> int:
    ...
    roster_out = app.create_shift_assignment(
        {
