# Mobile E2E release gate — 20260816T133658Z

**Suite:** `smoke`
**Evidence:** `ops/evidence/mobile-e2e-gate-20260816T133658Z`
...
Reason: Missing MOBILE_PASS for: unsigned entry, HR login/tabs, Employee activation credentials
...
- `UI.critical-ar` · **MOBILE_PASS** — Maestro flow passed on real UI runtime (ios:3D3C80A7-3B5A-4480-8FA2-554E16678995)
