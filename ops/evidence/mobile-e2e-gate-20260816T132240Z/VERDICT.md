# Mobile E2E release gate — 20260816T132240Z

**Suite:** `smoke`
**Evidence:** `ops/evidence/mobile-e2e-gate-20260816T132240Z`
...
- `UI.00-unsigned-entry` · **MOBILE_PASS** — Maestro flow passed on real UI runtime (ios:3D3C80A7-3B5A-4480-8FA2-554E16678995)
- `UI.05-method-switch-en` · **MOBILE_PASS** — Maestro flow passed on real UI runtime (ios:3D3C80A7-3B5A-4480-8FA2-554E16678995)
- `UI.01-hr-login` · **MOBILE_PASS** — Maestro flow passed on real UI runtime (ios:3D3C80A7-3B5A-4480-8FA2-554E16678995)
- `UI.02-hr-tabs` · **MOBILE_PASS** — Maestro flow passed on real UI runtime (ios:3D3C80A7-3B5A-4480-8FA2-554E16678995)
