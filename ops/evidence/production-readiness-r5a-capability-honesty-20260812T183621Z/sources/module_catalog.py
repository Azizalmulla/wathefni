...
Wave 4/6 Performance, Talent, Job Architecture, Learning, Benefits, ER,
Engagement, Compensation Planning, and Workforce Planning are intentionally
absent from this catalog until `customer_enableable` is true in
`capability_readiness.py`. Domain FULL_PASS is not a catalog SKU.
"""
