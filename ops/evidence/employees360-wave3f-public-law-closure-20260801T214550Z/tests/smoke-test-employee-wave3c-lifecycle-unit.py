...
def main() -> int:
    check("schema version wave3f", w3c.SCHEMA_VERSION.startswith("employees360-wave3f"), w3c.SCHEMA_VERSION)
    ...
    check("normalize migrates wave3f", (hidden.get("policy_json") or {}).get("wave") == "wave3f", hidden.get("policy_json"))
