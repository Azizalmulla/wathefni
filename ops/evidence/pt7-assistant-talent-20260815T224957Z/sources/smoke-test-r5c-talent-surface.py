...
def main() -> int:
    ...
    check("fail-closed skips Learning namespaces", ("learning", "/dashboard/learning") not in ready.all_http_namespaces() and ("learning", "/app/learning") not in ready.all_http_namespaces())
    ...
    check(
        ...
        learning_detail or learning.status_code,
    )
