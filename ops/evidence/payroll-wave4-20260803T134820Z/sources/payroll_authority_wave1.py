...
def create_contract_draft(
    ...
    *,
    ...
    if denied:
        return denied
    synth_ban = refuse_nonsynthetic_mutation(employee_key=employee_key, action="create_contract_draft")
    if synth_ban:
        return synth_ban
...
def seed_contract_from_offer(
    ...
    *,
    ...
    synth_ban = refuse_nonsynthetic_mutation(employee_key=employee_key, action="seed_contract_from_offer")
    if synth_ban:
        return synth_ban
