...
def main() -> int:
    ...
    try:
        with conn.cursor() as cur:
            ...
            check("company on v2", pub2.get("ok") is True and int(pub2["publication"]["effective_version"]) >= 2)
            ...
            check("pins definition version", int(ev.get("effective_version") or 0) >= 2)
