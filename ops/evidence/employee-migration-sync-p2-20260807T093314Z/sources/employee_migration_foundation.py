...
def honesty_payload() -> dict[str, Any]:
    base = {
        ...
        "expansion_phases_deferred": ["P3_onboarding_states", "P4_balances", "P5_connectors", "P6_leavers"],
    ...
    *,
    ...
    with legacy.db_connect() as conn:
        with conn.cursor() as cur:
            ...
            # Merge field-level review into row detail for Needs review visibility
            if notes["review"]:
