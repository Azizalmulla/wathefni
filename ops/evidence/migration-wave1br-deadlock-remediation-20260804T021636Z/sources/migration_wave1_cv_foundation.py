...
def apply_schema(cur: Any, *, force: bool = False) -> None:
    ...
    _schema.apply_sql(
        cur,
        SCHEMA_SQL,
        module="migration_wave1_cv_foundation",
        lock_id=770_911_104,
    )
...
def require_schema(cur: Any) -> None:
    ...
    _schema.require_relations(cur, REQUIRED_TABLES, module="migration_wave1_cv_foundation")
