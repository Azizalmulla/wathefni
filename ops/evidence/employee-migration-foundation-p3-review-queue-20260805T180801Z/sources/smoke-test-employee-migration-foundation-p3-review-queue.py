...
def main() -> None:
    ...
    try:
        ...
        # Approve → disappears from active queue immediately
        ...
        if salem_after:
            _fail(f"approved identity still in Needs review: {salem_after}")
        _ok("approve clears active queue for that identity")
