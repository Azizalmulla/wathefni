"""Migration & Sync P5.1 — Connected Systems connectors + sync runs.

Connectors fetch external rows and feed the existing foundation
preview/commit pipeline. No parallel apply engine.

P5.1 adds: production scheduler (locking / backoff / next_sync_at) and a real
SFTP/file-feed connector. Scheduler always invokes the same run_sync path.
"""
...
CONTRACT = "employee_migration_sync_p5_1_scheduler_sftp"
