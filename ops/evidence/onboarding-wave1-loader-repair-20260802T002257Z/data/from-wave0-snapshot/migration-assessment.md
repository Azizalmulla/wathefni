...
## Brian Saleh (`WATHEFNI-96599411617`)

- Live items: **1** → `personal_photo`
- Null owner/category rows: **0**
- Missing (35): access_card_issued, account_access_created, app_invite_sent, asset_handover, attendance_device_id, bank_details, civil_id, civil_id_expiry, code_of_conduct_ack, company_policy_ack, department_assigned, emergency_contact, employment_contract, first_day_checklist, job_title_confirmed, medical_check, nda_signed, offer_letter, passport, passport_expiry, payroll_status, personal_details_form, probation_end, reporting_manager_assigned, residence, residency_expiry, salary_allowances_confirmed, salary_transfer_details, shift_group_assigned, training_completed, uniform_ppe_issued, visa_article_type, work_location_assigned, work_permit, work_permit_expiry
- Obsolete (0): none
- Conflicts: none
