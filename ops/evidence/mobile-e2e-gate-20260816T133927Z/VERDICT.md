# Mobile E2E release gate — 20260816T133927Z

**Suite:** `smoke`
**Evidence:** `ops/evidence/mobile-e2e-gate-20260816T133927Z`
...
- `UI.00-unsigned-entry` · **MOBILE_PASS** — Maestro flow passed on real UI runtime (android:emulator-5554)
- `UI.05-method-switch-en` · **MOBILE_PASS** — Maestro flow passed on real UI runtime (android:emulator-5554)
- `UI.01-hr-login` · **MOBILE_PASS** — Maestro flow passed on real UI runtime (android:emulator-5554)
- `UI.02-hr-tabs` · **MOBILE_PASS** — Maestro flow passed on real UI runtime (android:emulator-5554)
