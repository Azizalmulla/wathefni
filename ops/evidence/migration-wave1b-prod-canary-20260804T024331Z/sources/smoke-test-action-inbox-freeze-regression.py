...
def main() -> int:
    ...
    check("phase0 viewer allowlist helper", "def real_viewer_allowlist" in w1)
    check("phase0 subject allowlist helper", "def real_subject_allowlist" in w1)
    check("phase0 nav offerable helper", "def nav_offerable_for_viewer" in w1)
    check("phase0 payroll exclude", "def exclude_payroll_stream" in w1)
    check("approved Aziz phone pinned", "96599338566" in w1)
    check("approved Talal key pinned", "WATHEFNI-96550252254" in w1)
