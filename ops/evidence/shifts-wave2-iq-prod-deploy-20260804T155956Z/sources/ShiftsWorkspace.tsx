      ...
      <div className={`grid gap-4 ${asideOpen && queue === 'board' ? 'xl:grid-cols-[minmax(0,1fr)_360px]' : ''}`}>
        ...
        <div>
          {queue === 'board' ? (
            <div
              className={cn(
                'relative -mt-1 overflow-hidden rounded-[1.55rem] border border-[#ded3c1] bg-[#fbf7ee] shadow-[0_14px_34px_rgba(35,33,29,0.055)]',
            ...
            >
              {refreshing && !coldLoading ? (
                <div
                  className="pointer-events-none absolute inset-x-0 top-0 z-10 flex h-7 items-center gap-2 bg-[#fbf7ee]/92 px-4 text-xs text-muted backdrop-blur-[1px]"
          ...
          {queue === 'rotations' && rotationsUsed ? (
            <div className="space-y-4 rounded-[1.55rem] border border-line/55 bg-white p-4 shadow-[0_18px_40px_rgba(35,33,29,0.08)]" data-testid="shifts-rotations-panel">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div>
...
function QueueCanvas({
  ...
  return (
    <div className="relative -mt-1 overflow-hidden rounded-[1.55rem] border border-[#ded3c1] bg-[#fbf7ee] shadow-[0_14px_34px_rgba(35,33,29,0.055)]">
      {refreshing ? (
        <div
          className="pointer-events-none absolute inset-x-0 top-0 z-10 flex h-7 items-center gap-2 bg-[#fbf7ee]/92 px-4 text-xs text-muted backdrop-blur-[1px]"
          data-shifts-updating
