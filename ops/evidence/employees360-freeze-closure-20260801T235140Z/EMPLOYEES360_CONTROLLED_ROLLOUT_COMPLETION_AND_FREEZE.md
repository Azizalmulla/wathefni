...
**Onboarding** — audit next.

| Criterion | Why Onboarding |
|---|---|
| Commercial value | Time-to-productivity after hire; reduces “hired but stuck” friction |
| Dependency order | Needs frozen Employees 360 identity/authority; precedes Attendance → Leave → Shifts → Payroll |
| Production risk | Seeds/checklist currently dark (`WATHEFNI_ONBOARDING_SEED=off`, HR mutate default off); blast radius lower than pay/time |
| Fit | Activation handoff + checklist already adjacent to employee profile; does not require redesigning E360 |