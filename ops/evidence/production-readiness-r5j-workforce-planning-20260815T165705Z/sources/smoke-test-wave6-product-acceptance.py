...
def main() -> int:
    ...
    check("setup engagement customer enableable after R5H", w6.honesty_payload().get("engagement_customer_enableable") is True)
    check("setup comp customer enableable after R5I", w6.honesty_payload().get("comp_planning_customer_enableable") is True)
    check("setup wfp honesty", w6.honesty_payload().get("workforce_planning_ja_hard") is True)
    check("setup wfp customer enableable after R5J", w6.honesty_payload().get("workforce_planning_customer_enableable") is True)
