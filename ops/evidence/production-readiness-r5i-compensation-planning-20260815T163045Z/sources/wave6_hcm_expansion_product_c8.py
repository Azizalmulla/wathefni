...
def frontend_setup_cards_scan(dashboard_setup_dir: Path | None = None) -> dict[str, Any]:
    ...
    # R5I: Job Architecture + Learning + Benefits + Employee Relations + Engagement
    # + Compensation Planning. Workforce Planning stays omitted.
    released = {
    ...
    return {
        "ok": not missing and not mounted_hidden and ja_mounted and ld_mounted and bn_mounted and er_mounted and eg_mounted and cp_mounted and app.exists(),
