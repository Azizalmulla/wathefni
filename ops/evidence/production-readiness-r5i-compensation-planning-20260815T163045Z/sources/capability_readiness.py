...
# Workforce Planning remains for R5J.
...
def annotate_wave6_setup(payload: Mapping[str, Any] | None) -> dict[str, Any]:
    ...
    honesty.update(
        {
            "customer_enableable": ja_on or ld_on or bn_on or er_on or eg_on or cp_on,
            "customer_visible_in_setup": ja_on or ld_on or bn_on or er_on or eg_on or cp_on,
    ...
    out["honesty"] = honesty
    out["customer_enableable"] = ja_on or ld_on or bn_on or er_on or eg_on or cp_on
    out["customer_visible"] = ja_on or ld_on or bn_on or er_on or eg_on or cp_on
    return out
