...
def main() -> int:
    ...
    check(
        ...
        CLEANUP_CONTRACT_VERSION.startswith("1.1")
        or CLEANUP_CONTRACT_VERSION.startswith("1.2")
        or CLEANUP_CONTRACT_VERSION.startswith("1.3")
        or CLEANUP_CONTRACT_VERSION.startswith("1.4"),
        CLEANUP_CONTRACT_VERSION,
    )
