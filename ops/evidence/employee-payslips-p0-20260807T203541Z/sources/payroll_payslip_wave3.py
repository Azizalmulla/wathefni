...
PAYROLL_WAVE3_VERSION = "1.1.0"
PAYSLIP_DOCUMENT_SCHEMA = "payroll_payslip_document@1.1.0"
...
def list_employee_released_payslips(
    ...
    *,
    ...
    cur.execute(
        ...
        LIMIT %s
        """,
        ((company_code or "").upper(), employee_key, max(1, min(int(limit or 24), 100))),
    )
    return [_annotate_payslip(r) for r in _rows(cur)]
    ...
    *,
    ...
    return {
        ...
        "payslip": {
            ...
            "download_kind": "statement_summary",
            "honesty": {
                "en": "This is a pay statement summary for your records. It does not authorize payment.",
                "ar": "هذا ملخص كشف راتب لسجلاتك. لا يُعد تفويضاً بالصرف.",
            },
        },
        "lines": safe_lines,
        "earnings": earnings,
