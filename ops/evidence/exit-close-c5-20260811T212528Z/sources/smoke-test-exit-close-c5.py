...
def main() -> int:
    ...
    with app.db_connect() as conn:
        with conn.cursor() as cur:
            ...
            # Incomplete offboarding blocks close intake
            c3.enable_company_exit_intent(
            ...
            # Path A: completed clearance, payroll absent, settlement not required
            ob_id = _build_completed_offboarding(cur, c3, c4, lwd=lwd_past)
