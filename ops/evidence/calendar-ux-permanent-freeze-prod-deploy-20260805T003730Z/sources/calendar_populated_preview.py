...
def build_preview_events(*, now: datetime | None = None) -> list[dict[str, Any]]:
    ...
    events.append(
        _event(
            ...
            title_ar="مقابلة · سارة · مصممة منتجات",
    ...
    events.append(
        _event(
            ...
            title="Meeting · Hiring sync",
            title_ar="اجتماع · مزامنة التوظيف",
            event_type="meeting",
            status="confirmed",
            start_at=s,
            end_at=e,
    ...
    events.append(
        _event(
            ...
            title="Employee start · Khaled",
            title_ar="بدء موظف · خالد",
            event_type="other",
            status="confirmed",
            start_at=s,
            end_at=e,
    ...
    events.append(
        _event(
            ...
            title="Interview · Omar · Ops Lead",
            title_ar="مقابلة · عمر · قائد العمليات",
            event_type="interview",
            status="tentative",
            start_at=s,
            end_at=e,
    ...
    events.append(
        _event(
            suffix="leave-nour",
            title="Approved leave · Nour",
            title_ar="إجازة معتمدة · نور",
    ...
    events.append(
        _event(
            ...
            title="Follow-up · Sara",
            title_ar="متابعة · سارة",
            event_type="deadline",
            status="confirmed",
            start_at=s,
            end_at=e,
    ...
    events.append(
        _event(
            suffix="onboard-docs",
            title="Onboarding · docs due",
            title_ar="إنهاء التعيين · المستندات",
            event_type="deadline",
            status="confirmed",
            start_at=s,
            end_at=e,
    ...
    events.append(
        _event(
            ...
            title="Interview · cancelled slot",
            title_ar="مقابلة · ملغاة",
            event_type="interview",
            status="cancelled",
            start_at=s,
            end_at=e,
    ...
    events.append(
        _event(
            ...
            title="Compliance · Civil ID",
            title_ar="امتثال · البطاقة المدنية",
            event_type="deadline",
            status="confirmed",
            start_at=s,
            end_at=e,
