...
TRIGGER_AUTO_CREATE = "auto_create"
TRIGGER_AUTO_ONBOARDING = "auto_onboarding"
...
def get_invitation_snapshot(legacy: Any, *, company_code: str, employee_key: str) -> dict[str, Any]:
    ...
    return {
        ...
        "actions": {
            "resend": public in {STATUS_PENDING, STATUS_SENT, STATUS_DELIVERED, STATUS_FAILED, STATUS_NEEDS_ATTENTION, STATUS_EXPIRED},
            "reinvite": public != STATUS_NONE or True,
...
def _deliver_code(legacy: Any, *, company: str, employee: dict[str, Any], code: str, invite_id: str, trigger_source: str) -> dict[str, Any]:
    outbound = legacy.deliver_app_activation_code(company, employee, code)
