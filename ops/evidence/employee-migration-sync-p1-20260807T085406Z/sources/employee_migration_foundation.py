...
CONTRACT = "employee_migration_sync_p1_foundation_only"
...
def honesty_payload() -> dict[str, Any]:
    return {
        ...
        "expansion_phases_deferred": ["P2_deep_records", "P3_onboarding_states", "P4_balances", "P5_connectors", "P6_leavers"],
    }
