...
def build_hr_workspace_capabilities(app_mod: Any, context: dict[str, Any]) -> dict[str, Any]:
    ...
    if role == "manager" and scope_blocked:
        ...
        keys = [
            "hr_tasks", "leave_approvals", "onboarding_review", "preboarding_review", "probation_review", "document_review",
    ...
    any_posthire = leave_mod or onboarding_mod or preboarding_mod or probation_mod or compliance_mod or attendance_mod or shifts_mod or _module_on(
