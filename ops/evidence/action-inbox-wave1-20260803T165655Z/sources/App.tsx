...
const navItems: DashboardNavItem[] = [
  ...
  { id: 'inbox', label: 'Action Inbox', icon: Inbox, group: 'posthire' },
...
function pageAvailableForSummary(page: Page, state: DashboardModuleState, authorityNavIds?: string[]) {
  ...
  if (page === 'inbox') return posthireModulesEnabled(state?.enabled_modules, workspaceCatalog(state))
...
const pageSubtitles: Record<Page, string> = {
  ...
  inbox: 'One ranked queue of what needs action — composed from Analytics, Compliance, and Employees 360.',
...
const pageSubtitlesAr: Record<Page, string> = {
  ...
  inbox: 'قائمة مرتّبة بما يحتاج إجراءً — من التحليلات والامتثال وملف الموظفين 360.',
