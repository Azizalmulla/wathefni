...
Wave 6 Job Architecture is a platform foundation (not a catalog SKU).
Performance, Talent, Learning, Benefits, Employee Relations, Engagement,
Compensation Planning, and Workforce Planning are catalog SKUs after R5B–R5J.
"""
...
MODULE_CATALOG: tuple[ModuleDefinition, ...] = (
    ...
    ModuleDefinition(
        ...
        app_surface_key="talent",
        app_surface_label="Career interests and mobility preferences",
    ),
    ModuleDefinition(
        "learning",
        ...
        app_surface_key="learning",
        app_surface_label="My learning, mandatory training, and certificates",
    ),
    ModuleDefinition(
        "benefits",
        "Benefits",
        ...
        app_surface_key="benefits",
        app_surface_label="My benefits, enrollment, and coverage",
    ),
    ModuleDefinition(
        "employee_relations",
        "Employee Relations",
        ...
        True,
        recommended_with=(),
        recommendation_copy="Works alone. Confidential need-to-know. Ordinary HR and managers do not gain case access. Outcome is not an employment mutation.",
    ...
    ModuleDefinition(
        ...
        app_surface_key="engagement",
        app_surface_label="Open surveys and participation",
    ),
    ModuleDefinition(
        "comp_planning",
        ...
        True,
        recommended_with=(),
        recommendation_copy="Requires Job Architecture. A plan is not a salary change, not payroll application, and not payment. KWD only — no hidden FX.",
        app_surface_key=None,
        app_surface_label=None,
    ),
    ModuleDefinition(
        ...
        True,
        recommended_with=(),
        recommendation_copy="Requires Job Architecture. Actual workforce is not a baseline, not a plan, and not approved execution. Planned headcount is not actual headcount. KWD only — no hidden FX.",
        app_surface_key=None,
        app_surface_label=None,
    ),
    ModuleDefinition(
...
MODULE_ALIASES = {
    ...
    "compensation_planning": "comp_planning",
    "compensation": "comp_planning",
