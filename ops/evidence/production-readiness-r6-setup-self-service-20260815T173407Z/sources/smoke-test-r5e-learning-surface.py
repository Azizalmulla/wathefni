...
def main() -> int:
    ...
    check("benefits now enableable after R5F", ready.customer_enableable("benefits") is True)
    ...
    check("Setup remounts Benefits after R5F", "Wave6BenefitsPoliciesCard" in setup_app)
