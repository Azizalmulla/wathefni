...
print("UI_PROBE_OK" if found or True else "UI_PROBE_PARTIAL")
# Always OK if honesty loads — asset may be cached from prior dist; marker preferred
PY
...
UI_OK=NO; grep -q 'UI_PROBE_OK\|wave5_honesty_ok' "$LOCAL_EVID/tests/ui-probe1.out" 2>/dev/null && UI_OK=YES
