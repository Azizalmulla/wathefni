...
MODULE_SURFACES = ("onboarding", "documents", "attendance", "shifts", "leave", "payslips", "bank", "performance")
HOME_TILES = ("shifts", "attendance", "leave", "documents", "payslips", "performance")
