...
def frontend_setup_cards_scan(dashboard_setup_dir: Path | None = None) -> dict[str, Any]:
    ...
    # R5E: Job Architecture + Learning Setup cards are customer-visible.
    # Remaining Wave 6 cards stay omitted.
    released = {"Wave6JobArchitecturePoliciesCard", "Wave6LearningPoliciesCard"}
    ...
    return {
        "ok": not missing and not mounted_hidden and ja_mounted and ld_mounted and app.exists(),
