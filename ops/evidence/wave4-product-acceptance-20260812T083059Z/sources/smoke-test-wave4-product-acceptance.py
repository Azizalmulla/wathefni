...
def main() -> int:
    ...
    check("Setup Wave4 card", (web / "setup-console/Wave4PerformanceTalentPoliciesCard.tsx").is_file())
    setup_app = (web / "setup-console/SetupConsoleApp.tsx").read_text(encoding="utf-8")
    check("Setup wires Wave4 card", "Wave4PerformanceTalentPoliciesCard" in setup_app)
