...
def frontend_setup_cards_scan(dashboard_setup_dir: Path | None = None) -> dict[str, Any]:
    ...
    # R5G: Job Architecture + Learning + Benefits + Employee Relations Setup cards
    # are customer-visible. Remaining Wave 6 cards stay omitted.
    released = {
    ...
    return {
        "ok": not missing and not mounted_hidden and ja_mounted and ld_mounted and bn_mounted and er_mounted and app.exists(),
