...
**Status:** FROZEN (qualified 2026-08-11) — AMENDS `ops/PAYROLL_CONTROLLED_ROLLOUT_COMPLETION_AND_FREEZE.md` for Wave 2 **C4 only**  
**Charter:** `WAVE2_WORKFORCE_TRUTH_CHARTER: APPROVED`  
**Pass stamp:** `PAYROLL_AUTHORITY_FULL_PASS` — evidence `ops/evidence/payroll-authoritative-c4-20260811T195852Z`  
...
C4 amendment is frozen. Stop for owner review. **Do not start C5 Payslips + Payment Files** until owner accepts `PAYROLL_AUTHORITY_FULL_PASS`.
