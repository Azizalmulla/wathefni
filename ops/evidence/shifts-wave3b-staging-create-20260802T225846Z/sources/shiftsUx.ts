...
export function shiftsCopy(locale: ShiftsLocale) {
  ...
  return {
    ...
    subtitle: isAr
      ? 'جدولة مباشرة للموارد البشرية والمدراء ضمن النطاق — بدون قوالب أو جداول متكررة.'
      : 'Direct scheduling for HR and scoped managers — no templates or recurring schedules.',
