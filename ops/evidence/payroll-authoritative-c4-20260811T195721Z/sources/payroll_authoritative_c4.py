...
def configure_input_feeds(
    ...
    *,
    ...
    att_mode = "required" if feeds["attendance"] else "ignored"
    ...
    policy_flags = {
        ...
        "lateness_money_enabled": feeds["attendance"],
        "absence_money_enabled": feeds["attendance"],
        "unpaid_leave_money_enabled": feeds["leave"],
        "ot_money_enabled": feeds["ot"],
        "rest_day_money_enabled": False,
        "public_holiday_money_enabled": False,
        "sick_leave_money_enabled": feeds["leave"],
    }
    _audit(
        cur,
        company_code=company,
