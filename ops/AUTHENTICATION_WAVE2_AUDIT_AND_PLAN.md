...
### Readiness decision (updated 2026-08-06T214259Z)

**Status: ready_for_phase_1.** Formal decision: `ops/AUTH_WAVE2_READINESS_DECISION.md`.  
Frozen Wave 1 contract: `ops/AUTH_WAVE1_FROZEN_CONTRACT.md` · evidence `ops/evidence/auth-wave1-freeze-20260806T214259Z/`.  
Do **not** start Phase 1 until explicitly authorized. Keep biometrics, idle lock, recovery, and device trust in later phases.
