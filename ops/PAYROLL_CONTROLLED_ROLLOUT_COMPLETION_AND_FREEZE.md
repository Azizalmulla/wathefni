...
- Native results **non-authoritative** by default; external payroll remains **money authority** unless Wave 2 C4 company-scoped `payroll.authoritative_finalize` is entitled (`ops/PAYROLL_AUTHORITY_C4_FREEZE_AMENDMENT.md`)
