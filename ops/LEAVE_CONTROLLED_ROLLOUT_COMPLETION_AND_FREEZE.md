...
10. **Do not set `enforced=true`**, calculate Payroll money, or broadly onboard employees without a new owner-approved wave.
    - Wave 2 C2 amendment: `ops/LEAVE_ENFORCEMENT_C2_FREEZE_AMENDMENT.md` — company-scoped enforcement after pack attestation; global `WATHEFNI_LEAVE_ENFORCEMENT` remains off.
