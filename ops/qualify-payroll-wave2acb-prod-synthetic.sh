...
with app.db_connect() as conn:
  with conn.cursor() as cur:
    cur.execute("""
      ...
      WHERE company_code='WATHEFNI' AND employee_key LIKE 'WATHEFNI-PYW1-W2ACB-%'
    """)
...
export WATHEFNI_EXPECTED_DATABASE_PORT=5432
export WATHEFNI_DATABASE_ENVIRONMENT_MARKER=wathefni-production-isolation-v1
# Wave 2A freeze honesty (staging smoke refuses prod DB by design)
\$PY - <<'PY'
...
print("WAVE2A_FREEZE_HONESTY_OK")
PY
