...
| IQ-12 | Shifts | Filters / drawer / confirm | P1 | Undebounced filters, strip jump, incomplete confirm | Local | Debounce + sticky + confirm path | **Resolved in Shifts Visual & UX Wave 2** (`20260804T155956Z`) | **Shipped** |
...
| Shifts filter debounce, sticky drawer, `needs_confirmation` completion | **Resolved** — Shifts Visual & UX Wave 2 `20260804T155956Z` |
